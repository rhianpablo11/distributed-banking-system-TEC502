...
function CardInfoTransaction(props){
    //colocar o icone de acordo com o tipo da transação, se for de mandar ou de recber
    //tem que ver tambem a questao dos dados quando recebe e quando envia
    ...
    return (
        <>
            <div onClick={selectTransaction} className={styles.infoTransactionBlockList}>
                ...
                <div className={styles.infoTechnicalAboutTransaction}>
                    <h2 style={{'font-size': '1.5rem', 'font-weight': '500'}}>
                        {moneyOutOrReceive ? "To" : "From"}
                    </h2>
                    <h2 style={{'padding-left':'15px'}}>
                        {moneyOutOrReceive ? transaction.receptor : transaction.source}
...
CardInfoTransaction.propsTypes = {
    transaction: propsTypes.object
}

CardInfoTransaction.defaultProps = {
    transaction: {
        'source': undefined,
        'receptor':undefined,
        'value': undefined,
