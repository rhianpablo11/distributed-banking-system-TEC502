...
Para operação de **realizar um depósito**, o padrão de dado esperado pelo servidor é:
```javascript
"dataOperation": {
...
```
Para operação de **enviar um pacote de pix**, o padrão de dado esperado pelo servidor é:
```javascript
"dataOperation": [
    {
        "value": "valor a ser enviado",
