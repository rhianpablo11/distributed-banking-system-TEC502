...
from storage import network_storage, accounts_storage, keys_storage
...
if(os.getenv('id_bank') != None and os.getenv('bank_0') != None and os.getenv('bank_1') != None and os.getenv('bank_2') != None and os.getenv('bank_3') != None and os.getenv('secret_key_jwt') != None):
    ...
    keys_storage.set_jwt_secret_key(os.getenv('secret_key_jwt'))

else:
    network_storage.set_self_id('0')
    network_storage.set_address_bank('0', 'http://localhost:10000')
    keys_storage.set_jwt_secret_key('local test')
